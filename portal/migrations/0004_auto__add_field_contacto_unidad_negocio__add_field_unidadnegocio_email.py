...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contacto.unidad_negocio'
        db.add_column('portal_contacto', 'unidad_negocio', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['portal.UnidadNegocio']), keep_default=False)

        # Adding field 'UnidadNegocio.email_contacto'
        db.add_column('portal_unidadnegocio', 'email_contacto', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contacto.unidad_negocio'
        db.delete_column('portal_contacto', 'unidad_negocio_id')

        # Deleting field 'UnidadNegocio.email_contacto'
        db.delete_column('portal_unidadnegocio', 'email_contacto')
