...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UnidadNegocio.logo_inactivo'
        db.delete_column('portal_unidadnegocio', 'logo_inactivo')

        # Deleting field 'UnidadNegocio.background'
        db.delete_column('portal_unidadnegocio', 'background')

        # Adding field 'UnidadNegocio.bg_image'
        db.add_column('portal_unidadnegocio', 'bg_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UnidadNegocio.logo_inactivo'
        db.add_column('portal_unidadnegocio', 'logo_inactivo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'UnidadNegocio.background'
        db.add_column('portal_unidadnegocio', 'background', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'UnidadNegocio.bg_image'
        db.delete_column('portal_unidadnegocio', 'bg_image')
