...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Actividad.campania'
        db.add_column('portal_actividad', 'campania', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['portal.Campania']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Actividad.campania'
        db.delete_column('portal_actividad', 'campania_id')
    ...
    models = {
        ...
        'portal.actividad': {
            ...
            'campania': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['portal.Campania']"}),
